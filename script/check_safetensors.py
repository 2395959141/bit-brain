...
def quick_test(safetensors_path):
    ...
    try:
        ...
        config = AutoConfig.from_pretrained("/home/chenyuhang/bit-brain/bitbrain/models/pertrain_qwen3_0.6B")
        ...
        model = AutoModelForCausalLM.from_pretrained(
            "/home/chenyuhang/bit-brain/bitbrain/models/pertrain_qwen3_0.6B", 
            config=config,
            torch_dtype=torch.float16,
            trust_remote_code=True
        )
        tokenizer = AutoTokenizer.from_pretrained("/home/chenyuhang/bit-brain/bitbrain/models/pertrain_qwen3_0.6B")
