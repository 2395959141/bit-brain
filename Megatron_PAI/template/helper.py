...
from Megatron_PAI import training 

from Megatron_PAI.training import get_args, get_timers
from Megatron_PAI.training.utils import (
...
from Megatron_PAI.data.utils import (
