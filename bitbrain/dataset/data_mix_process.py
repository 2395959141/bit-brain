...
def main():
    ...
    parser.add_argument("--data_paths", type=str, nargs='+', default=["/DATA/disk2/yuhang/.cache/steel_dataset/step2_split_jsonl"], help="Paths to the directories containing .parquet files.")
    parser.add_argument("--tokenizer_name", type=str, default="Qwen/Qwen2.5-0.5B-instruct", help="Name or path of the tokenizer.")
    parser.add_argument("--max_length", type=int, default=2048, help="Maximum sequence length for tokenization.")
    parser.add_argument("--output_dir", type=str, default="/DATA/disk2/yuhang/.cache/steel_dataset/step3_tokenizer_data", help="Directory to save the processed dataset.")
