##
#!  进一步添加DDP分布式训练支持, 并开启swanlab支持
#!  精简后的代码，默认开启 混合精度，梯度重计算 和 torch.compile
import os
import sys
import argparse
...
lr_scheduler_config = {
    ...
    "max_lr": 3e-4,                          # 最大学习率
    "min_lr": 3e-5,                          # 最小学习率（最大学习率的10%）
    "warmup_steps": 2500,                     # 热身步数
    "warmup_ratio": 0.05,                    # 热身比例（如果warmup_steps为None则使用此值）
}
