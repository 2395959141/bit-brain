#
#! 参考自Steel-LLM项目
#! 具体代码：https://github.com/zhanshijinwat/Steel-LLM/blob/main/data/pretrain_data_prepare/step2/steel_project_txt.yaml
...
export_path: '/DATA/disk2/yuhang/.cache/bit_brain_data/sft_llamafactory/translation/tranlation.jsonl'                # path to processed result dataset. Supported suffixes include ['jsonl', 'json', 'parquet']
